                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-sm-offset-6">
                                ...
                                <a href="${context}/StrategictSearchServlet?menu=project-plan" class="btn btn-warning">
                                    <i class="glyphicon glyphicon-erase"></i> Reset
                                </a>
                                <a href="${context}/StrategicAddServlet?menu=project-form" class="btn btn-default btn-primary">
